...
public enum MangaGenre {
	...
	@JsonProperty("Seinen")            SEINEN(41, "Seinen"),
	@JsonProperty("Josei")             JOSEI(42, "Josei"),
	@JsonProperty("Crossdressing")     CROSSDRESSING(44, "Crossdressing"),
	@JsonProperty("Suspense")          SUSPENSE(45, "Suspense"),
	...
	@JsonProperty("Memoir")            MEMOIR(68, "Memoir"),
	@JsonProperty("Organized Crime")   ORGANIZED_CRIME(69, "Organized Crime"),
	@JsonProperty("Otaku Culture")     OTAKU_CULTURE(70, "Otaku Culture"),
	@JsonProperty("Performing Arts")   PERFORMING_ARTS(71, "Performing Arts"),
	@JsonProperty("Pets")              PETS(72, "Pets"),
	@JsonProperty("Reincarnation")     REINCARNATION(73, "Reincarnation"),
	@JsonProperty("Reverse Harem")     REVERSE_HAREM(74, "Reverse Harem"),
	@JsonProperty("Romantic Subtext")  ROMANTIC_SUBTEXT(75, "Romantic Subtext"),
	@JsonProperty("Showbiz")           SHOWBIZ(76, "Showbiz"),
	@JsonProperty("Survival")          SURVIVAL(77, "Survival"),
	@JsonProperty("Team Sports")       TEAM_SPORTS(78, "Team Sports"),
	@JsonProperty("Time Travel")       TIME_TRAVEL(79, "Time Travel"),
	@JsonProperty("Video Game")        VIDEO_GAME(80, "Video Game"),
	@JsonProperty("Villainess")        VILLAINESS(81, "Villainess"),
	@JsonProperty("Visual Arts")       VISUAL_ARTS(82, "Visual Arts"),
	...
	MangaGenre(int id, String displayName) {
		this.id = id;
